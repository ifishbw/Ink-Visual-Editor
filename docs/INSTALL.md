...
| `InkVisual-0.1.0-x86_64.AppImage` | Linux | A single file that runs on almost any distribution. |
| `InkVisual-0.1.0-amd64.deb` | Debian, Ubuntu, Mint, Pop!_OS | A system package. |
...
```sh
sha256sum InkVisual-0.1.0-x86_64.AppImage
```
